...
var Re = (a, s, r) =>
    s in a
      ? Nt(a, s, { enumerable: !0, configurable: !0, writable: !0, value: r })
      : (a[s] = r),
  x = (a, s) => {
    for (var r in s || (s = {})) Ie.call(s, r) && Re(a, r, s[r]);
    if (ue) for (var r of ue(s)) je.call(s, r) && Re(a, r, s[r]);
    return a;
  },
  j = (a, s) => wt(a, yt(s));
var xe = (a, s) => {
  var r = {};
  for (var n in a) Ie.call(a, n) && s.indexOf(n) < 0 && (r[n] = a[n]);
  if (a != null && ue)
    for (var n of ue(a)) s.indexOf(n) < 0 && je.call(a, n) && (r[n] = a[n]);
  return r;
};
import {
  r as l,
...
const B = l.exports.createContext(),
  Wt = ({ children: a }) => {
    const s = W(),
      ...
      [g, S] = l.exports.useState(!1),
      [E, w] = l.exports.useState(!1),
      [A, N] = l.exports.useState(!1),
      [L, O] = l.exports.useState(!1),
      [k, V] = l.exports.useState(!1),
      [I, C] = l.exports.useState(!1),
      [G, v] = l.exports.useState(!1),
      [f, y] = l.exports.useState([]),
      [H, F] = l.exports.useState(!1),
      [te, le] = l.exports.useState(!1),
      [u, re] = l.exports.useState([]),
      [Se, Ae] = l.exports.useState([]),
      [ce, Le] = l.exports.useState(''),
      [Ee, Me] = l.exports.useState([]),
      [oe, Oe] = l.exports.useState(''),
      [ze, Be] = l.exports.useState([]),
      [de, me] = l.exports.useState(!0),
      [he, pe] = l.exports.useState(!0),
      [Fe, He] = l.exports.useState([]),
      [Ye, $e] = l.exports.useState([]),
      [et, tt] = l.exports.useState(!1),
      [at, st] = l.exports.useState(null),
      [lt, rt] = l.exports.useState(null),
      [it, nt] = l.exports.useState(null),
      ct = (M) => {
        N((K) => !K);
      };
    function ot() {
      ...
      return fetch('https://dev.hubmine.mx/api/auth/send_register/', {
        ...
        .then((K) => {
          if (K.code) {
            y(K);
            let gt = K;
            sessionStorage.setItem('code', gt.code),
              i(!0),
              setTimeout(() => {
    ...
    const mt = async () => {
      fetch(
        `https://dev.hubmine.mx/api/suppliers/product/list?supplier-id=${ie}`
      )
        .then((M) => M.json())
        .then((M) => {
          re(M);
    ...
    const xt = async () => {
      fetch(`https://dev.hubmine.mx/api/suppliers/list-states?country-id=${ce}`)
        .then((M) => M.json())
        .then((M) => {
          Me(M), me(!1);
        });
    ...
    const ft = async () => {
      fetch(`https://dev.hubmine.mx/api/suppliers/list-cities?state-id=${oe}`)
        .then((M) => M.json())
        .then((M) => {
          Be(M), pe(!1);
        });
    ...
    const vt = async () => {
      fetch(`https://dev.hubmine.mx/api/suppliers/plant/list?supplier-id=${ie}`)
        .then((M) => M.json())
        .then((M) => $e(M)),
        le(!1);
    };
    return (
      ...
      e(B.Provider, {
        value: {
          ...
          setSizeInvalid: b,
          bannerErrorOpen: g,
          setBannerErrorOpen: S,
          bannerSuccessOpen: E,
          setBannerSuccessOpen: w,
          dangerModalOpen: k,
          setDangerModalOpen: V,
          productReload: H,
          setProductReload: F,
          plantReload: te,
          setPlantReload: le,
...
const ae = () => Ct('./src/css/tailwind.config.js');
D.register(Ve);
D.defaults.font.family = '"Inter", sans-serif';
D.defaults.font.weight = '500';
D.defaults.color = ae().theme.colors.slate[400];
D.defaults.scale.grid.color = ae().theme.colors.slate[100];
D.defaults.plugins.tooltip.titleColor = ae().theme.colors.slate[800];
D.defaults.plugins.tooltip.bodyColor = ae().theme.colors.slate[800];
D.defaults.plugins.tooltip.backgroundColor = ae().theme.colors.white;
D.defaults.plugins.tooltip.borderWidth = 1;
D.defaults.plugins.tooltip.borderColor = ae().theme.colors.slate[200];
D.defaults.plugins.tooltip.displayColors = !1;
D.defaults.plugins.tooltip.mode = 'nearest';
D.defaults.plugins.tooltip.intersect = !1;
D.defaults.plugins.tooltip.position = 'nearest';
D.defaults.plugins.tooltip.caretSize = 0;
D.defaults.plugins.tooltip.caretPadding = 20;
D.defaults.plugins.tooltip.cornerRadius = 4;
D.defaults.plugins.tooltip.padding = 8;
D.register({
  id: 'chartAreaPlugin',
  beforeDraw: (a) => {
    if (
...
function ee({ children: a }) {
  return localStorage.getItem('token') ? a : e(ne, { to: '/signin' });
}
function qe({ children: a }) {
  return localStorage.getItem('token') ? e(ne, { to: '/' }) : a;
}
function Kt({ children: a }) {
  return sessionStorage.getItem('code') ? a : e(ne, { to: '/signin' });
}
const Ze = ({ children: a }) =>
    sessionStorage.getItem('id') ? a : e(ne, { to: '/signin' }),
  Jt = ({ children: a }) =>
    sessionStorage.getItem('number') ? a : e(ne, { to: '/signin' });
function fe({ children: a, activecondition: s }) {
...
function Z({ sidebarOpen: a, setSidebarOpen: s }) {
  const r = Pe(),
    { pathname: n } = r,
...
function Ue(g) {
  ...
  const E = s.split(' ').filter((v) => v.length),
    w = r.split(' ').filter((v) => v.length),
    A = n.split(' ').filter((v) => v.length),
    N = c.split(' ').filter((v) => v.length),
    L = i.split(' ').filter((v) => v.length),
    O = o.split(' ').filter((v) => v.length),
    k = h;
  function V(v, f) {
    f.length && v.classList.add(...f);
  }
  function I(v, f) {
    f.length && v.classList.remove(...f);
  }
  const C = $.useRef(null);
  return e(kt, {
    appear: d,
    ...
    in: a,
    addEndListener: (v) => {
      C.current.addEventListener('transitionend', v, !1);
    },
    onEnter: () => {
      k || (C.current.style.display = null), V(C.current, [...E, ...w]);
    },
    onEntering: () => {
      I(C.current, w), V(C.current, A);
    },
    onEntered: () => {
      I(C.current, [...A, ...E]);
    },
    ...
    onExiting: () => {
      I(C.current, L), V(C.current, O);
    },
    onExited: () => {
      I(C.current, [...O, ...N]), k || (C.current.style.display = 'none');
    },
    children: e(
      p,
      j(x({ ref: C }, b), {
        style: { display: k ? null : 'none' },
        children: m,
      })
    ),
  });
...
function R(n) {
  var c = n,
    { show: a, appear: s } = c,
    r = xe(c, ['show', 'appear']);
  const { parent: i } = l.exports.useContext(_e),
    o = Qt();
  return a === void 0
    ? e(Ue, x({ appear: i.appear || !i.isInitialRender, show: i.show }, r))
    : e(_e.Provider, {
        value: { parent: { show: a, isInitialRender: o, appear: s } },
        children: e(Ue, x({ appear: s, show: a }, r)),
      });
}
function Xt({ align: a }) {
...
D.register(St, At, Lt, Et, Mt, Ot, Ve);
D.register(zt, Bt, Ve, Ft);
function $t() {
  const [a, s] = l.exports.useState(!1);
  return t('div', {
    className: 'flex h-screen overflow-hidden',
    children: [
      e(Z, { sidebarOpen: a, setSidebarOpen: s }),
      t('div', {
        className:
...
var ea = '/assets/404-illustration.a20d59b6.svg';
function ta() {
  return e('div', {
    className: 'flex h-screen overflow-hidden',
    children: e('div', {
...
var be = '/assets/AuthImage.9cda46fa.jpg',
  se = '/assets/logohubsupplier.46f30f9d.svg';
function aa() {
  const [a, s] = l.exports.useState(!1),
    [r, n] = l.exports.useState(!1),
    {
      ...
      .then((w) => {
        if (w.customer_type_id === 2) {
          ...
          localStorage.setItem('token', A.token),
            ...
            localStorage.setItem('first_name', A.first_name),
            localStorage.setItem('email', A.email),
            localStorage.setItem('supplier_id', A.supplier_id),
            localStorage.setItem('id', A.id);
          async function O() {
            return fetch(
              `https://dev.hubmine.mx/api/suppliers/validate/${N}/`,
              {
                method: 'POST',
                headers: { 'Content-type': 'application/json' },
          ...
          w.customer_type_id === 1
            ...
            : w.code === 403 &&
              ...
              s(!0),
              setTimeout(() => {
                sessionStorage.setItem('id', w.id),
                  s(!1),
                  h('/multiStep'),
                  o(!1);
              }, 1500));
...
var ve = '/assets/auth-decoration.a3f89aec.png',
  sa = '/assets/createAccount.49879497.jpg';
function la() {
  const {
      eye: a,
      toggleEye: s,
      ...
      .then((E) => {
        if (E.code === 201) {
          ...
          sessionStorage.setItem('id', w.id),
            ...
            sessionStorage.setItem('first_name', w.first_name),
            setTimeout(() => {
              i(!1), b('/multiStep');
            }, 1500);
        } else
...
const na = () => {
  const a = W(),
    ...
    [b, g] = l.exports.useState(!1),
    S = () => sessionStorage.removeItem('code');
  l.exports.useEffect(() => {
    if (d) {
      const k = d > 0 && setInterval(() => h(d - 1), 1e3);
      return () => clearInterval(k);
    } else d === 0 && m(!0);
  }, [d]);
  const E = { code: i.join(''), number: n.number },
    w = n.number,
    A = { number: w },
    N = n.code,
    L = (k, V) => {
      if (isNaN(k.value)) return !1;
      o([...i.map((I, C) => (C === V ? k.value : I))]),
        k.nextSibling && k.nextSibling.focus();
    };
  async function O() {
    return fetch('https://dev.hubmine.mx/api/auth/validate/', {
      ...
      .then((k) => {
        if (k.msg === 'Ok') {
          g(!0);
          let V = k;
          sessionStorage.setItem('number', V.number),
            setTimeout(() => {
              g(!1), a('/signup');
            }, 1500);
        } else
...
var Je = '/assets/question.97bcae66.jpg';
const ca = () => {
    ...
    async function w(A) {
      return fetch(`https://dev.hubmine.mx/api/suppliers/create/${d}/`, {
        method: 'POST',
        headers: { 'Content-type': 'application/json' },
        ...
        .then((N) => {
          N.code === 201
            ? (p(!0),
              localStorage.setItem('first_name', N.first_name),
              localStorage.setItem('supplier_id', N.supplier_id),
...
function Y({ children: a, id: s, modalOpen: r, setModalOpen: n }) {
...
function T({ children: a, className: s, type: r, open: n, setOpen: c }) {
  const i = (d) => {
    switch (d) {
      case 'warning':
        return e('svg', {
...
const ma = {
  ...
  ha = { borderColor: '#0DB1AC' },
  pa = { borderColor: '#0DB1AC' },
  ua = { borderColor: '#0DB1AC' };
function xa({ files: a, setFiles: s }) {
...
const fa = () => {
    const a = W(),
      ...
      n = localStorage.getItem('supplier_id'),
      {
        ...
        setValue: o,
        formState: { errors: d },
      } = J({ defaultValues: { img_product: s } }),
      {
        setDangerModalOpen: h,
        bannerSuccessOpen: p,
        setBannerSuccessOpen: m,
        bannerErrorOpen: b,
        setBannerErrorOpen: g,
        loading: S,
        setLoading: E,
        setProductReload: w,
        setRequiredFile: A,
            ...
            t('div', {
              ...
              children: [
                ...
                t('form', {
                  onSubmit: c(async (L) => {
                    let O = new FormData();
                    O.append('category_id ', L.category_id),
                      O.append('unity_id', L.unity_id),
                      O.append('name', L.name),
                      O.append('short_description', L.short_description),
                      O.append('description ', L.description),
                      O.append('mark ', L.mark),
                      O.append('currency_id ', L.currency_id),
                      O.append('price ', L.price),
                      O.append('img_product', s[0]),
                      fetch(
                        `https://dev.hubmine.mx/api/suppliers/product/create/${n}/`,
                        { method: 'POST', body: O }
                      ).then((k) => {
                        k.status === 201
                          ? (m(!0),
  ...
  va = ({ id: a }) => {
    const {
      ...
      o = async (d) => {
        fetch(`https://dev.hubmine.mx/api/suppliers/product/delete/${d}/`, {
          method: 'DELETE',
        }).then((h) => {
          h.status === 204
            ? (n(!0),
...
const ya = () => {
  ...
  ka = () => {
    const a = W(),
      ...
      } = l.exports.useContext(B),
      {
        ...
        setValue: G,
        formState: { errors: v },
      } = J({ defaultValues: { address: '', longitude: '', latitude: '' } });
    async function f(y) {
      return fetch(`https://dev.hubmine.mx/api/suppliers/plant/create/${h}/`, {
        method: 'POST',
        headers: { 'Content-type': 'application/json' },
                          ...
                          children: t('div', {
                            children: [
                              ...
                              v.phone_contact &&
                                e('span', {
                                  className: 'text-red-500 text-sm',
                                  children: v.phone_contact.message,
                                }),
                            ],
                          }),
                        }),
                          ...
                          children: t('div', {
                            children: [
                              ...
                              v.type_place_id &&
                                e('span', {
                                  className: 'text-red-500 text-sm',
                                  children: v.type_place_id.message,
                                }),
                            ],
                          }),
                        }),
                        ...
                        t('div', {
                          children: [
                            ...
                            v.city_id &&
                              e('span', {
                                className: 'text-red-500 text-sm',
                                children: v.city_id.message,
                              }),
                          ],
                        }),
                      ],
                    }),
                    e('section', { className: 'mt-8', children: e(Xe, {}) }),
                    t('section', {
                      className: 'grid gap-5 md:grid-cols-3 mt-8',
                      children: [
                        t('div', {
                        ...
                        children: t('div', {
                          children: [
                            ...
                            v.observations &&
                              e('span', {
                                className: 'text-red-500 text-sm',
                                children: v.observations.message,
                              }),
                          ],
                        }),
                      }),
  ...
  Aa = ({ id: a }) => {
    const {
      ...
      o = async (d) => {
        fetch(`https://dev.hubmine.mx/api/suppliers/plant/delete/${d}/`, {
          method: 'DELETE',
        }).then((h) => {
          h.status === 204
            ? (n(!0),
  ...
  Oa = () => {
    const [a, s] = l.exports.useState([]),
      ...
      te = async () => {
        fetch(
          `https://dev.hubmine.mx/api/suppliers/plant/list/details?plant-id=${n}`
        )
          .then((u) => u.json())
          .then((u) => {
            H('name', u[0].name),
              H('phone_contact', u[0].phone_contact),
              H('type_place', u[0].type_place.type_place),
              H('type_place_id', u[0].type_place.type_place_id),
              H('country', u[0].location.country),
              H('country_id', u[0].location.country_id),
              H('state', u[0].location.state),
              H('state_id', u[0].location.state_id),
              H('city', u[0].location.city),
              H('city_id', u[0].location.city_id),
              H('observations', u[0].location.observations),
              H('latitude', u[0].location.latitude),
              H('longitude', u[0].location.longitude),
              H('address', u[0].location.address),
              s(u),
              V(u[0].location.address),
              v(u[0].location.longitude),
              ...
              t('div', {
                ...
                children: [
                  ...
                  t('form', {
                    onSubmit: f(async (u) => {
                      fetch(
                        `https://dev.hubmine.mx/api/suppliers/plant/update/${n}/`,
                        {
                          method: 'PUT',
                          headers: { 'Content-Type': 'application/json' },
                            ...
                            children: t('div', {
                              children: [
                                ...
                                F.phone_contact &&
                                  e('span', {
                                    className: 'text-red-500 text-sm',
                                    children: F.phone_contact.message,
                                  }),
                              ],
                            }),
                          }),
                            ...
                            children: t('div', {
                              children: [
                                ...
                                F.type_place_id &&
                                  e('span', {
                                    className: 'text-red-500 text-sm',
                                    children: F.type_place_id.message,
                                  }),
                              ],
                            }),
                          }),
                          ...
                          children: t('div', {
                            children: [
                              ...
                              F.observations &&
                                e('span', {
                                  className: 'text-red-500 text-sm',
                                  children: F.observations.message,
                                }),
                            ],
                          }),
                        }),
...
const Fa = {
  ...
  Ha = { borderColor: '#0DB1AC' },
  Va = { borderColor: '#0DB1AC' },
  Pa = { borderColor: '#0DB1AC' };
function qa({ logo: a, setLogo: s, supplierData: r }) {
  const n = l.exports.useCallback((g) => {
      s(g.map((S) => Object.assign(S, { preview: URL.createObjectURL(S) })));
    }, []),
    {
      getRootProps: c,
      getInputProps: i,
  ...
  l.exports.useEffect(
    () => () => {
      a.forEach((g) => URL.revokeObjectURL(g.preview));
    },
    [a]
  ),
    J();
...
function Da() {
  const [a, s] = l.exports.useState([]),
    ...
    S = localStorage.getItem('supplier_id'),
    E = async () => {
      let N = new FormData();
      N.append('logo', r[0]),
        fetch(`https://dev.hubmine.mx/api/suppliers/upload-logo/${S}/`, {
          method: 'POST',
          body: N,
        }).then((L) => L.json());
    },
    w = async () => {
      fetch(`https://dev.hubmine.mx/api/suppliers/details?supplier-id=${S}`)
        .then((N) => N.json())
        .then((N) => {
          s(N[0].bussiness_logo),
            b('commercial_brand', N[0].commercial_brand),
            b('bussiness_email', N[0].bussiness_email),
            b('bussiness_phone', N[0].bussiness_phone),
            b('rfc', N[0].rfc),
            b('social_reason', N[0].social_reason);
        });
    };
  return (
    l.exports.useEffect(() => {
    ...
    t('div', {
      ...
      children: [
        t('div', {
          ...
          children: [
            ...
            e('section', {
              children: e('div', {
                className: 'flex items-center',
                children: e(qa, { supplierData: a, logo: r, setLogo: n }),
              }),
            }),
          ],
        }),
        e('form', {
          onSubmit: p(async (N) => {
            fetch(`https://dev.hubmine.mx/api/suppliers/update/${S}/`, {
              method: 'PUT',
              headers: { 'Content-Type': 'application/json' },
                      ...
                      t('div', {
                        ...
                        children: [
                          ...
                          g.commercial_brand &&
                            e('span', {
                              className: 'text-red-500 text-sm',
                              children: g.commercial_brand.message,
                            }),
                        ],
                      }),
                      t('div', {
                        ...
                        children: [
                          ...
                          g.bussiness_phone &&
                            e('span', {
                              className: 'text-red-500 text-sm',
                              children: g.bussiness_phone.message,
                            }),
                        ],
                      }),
                      t('div', {
                  ...
                  t('div', {
                    ...
                    children: [
                      ...
                      g.bussiness_email &&
                        e('span', {
                          className: 'text-red-500 text-sm',
                          children: g.bussiness_email.message,
                        }),
                    ],
                  }),
                ],
                  ...
                  t('div', {
                    ...
                    children: [
                      ...
                      g.social_reason &&
                        e('span', {
                          className: 'text-red-500 text-sm',
                          children: g.social_reason.message,
                        }),
                    ],
                  }),
                ],
...
function U({ children: a, className: s, bg: r, size: n, position: c }) {
...
function ge({ children: a, className: s, type: r, open: n, setOpen: c }) {
  const i = (d) => {
    switch (d) {
      case 'warning':
        return e('svg', {
...
function Ne({ children: a, className: s, type: r, open: n, setOpen: c }) {
  const i = (d) => {
    switch (d) {
      case 'warning':
        return e('svg', {
...
function Ya() {
  const [a, s] = l.exports.useState(!1),
    ...
    [g, S] = l.exports.useState(!0),
    [E, w] = l.exports.useState(!0),
    [A, N] = l.exports.useState(!0),
    [L, O] = l.exports.useState(!0),
    [k, V] = l.exports.useState(!0),
    [I, C] = l.exports.useState(!0),
    [G, v] = l.exports.useState(!0),
    [f, y] = l.exports.useState(!0),
    [H, F] = l.exports.useState(!0),
    [te, le] = l.exports.useState(!0),
    [u, re] = l.exports.useState(!0),
    [Se, Ae] = l.exports.useState(!0),
    [ce, Le] = l.exports.useState(!0),
    [Ee, Me] = l.exports.useState(!0),
    [oe, Oe] = l.exports.useState(!0),
    [ze, Be] = l.exports.useState(!0),
    [de, me] = l.exports.useState(!0),
    [he, pe] = l.exports.useState(!0),
...
function ke({ children: a, id: s, title: r, modalOpen: n, setModalOpen: c }) {
...
function $a({ children: a, id: s, title: r, modalOpen: n, setModalOpen: c }) {
  const i = l.exports.useRef(null);
  return (
    l.exports.useEffect(() => {
      const o = ({ target: d }) => {
...
function De({ children: a, id: s, modalOpen: r }) {
...
var es = '/assets/announcement-icon.90ad60fe.svg',
  ts = '/assets/modal-image.f36b2fb4.jpg';
function as() {
  const [a, s] = l.exports.useState(!1),
    [r, n] = l.exports.useState(!1),
    [c, i] = l.exports.useState(!1),
...
function is() {
  ...
  return (
    ...
    e(Wt, {
      children: t(Zt, {
        children: [
          e(q, { path: '/signin', element: e(qe, { children: e(aa, {}) }) }),
          e(q, {
            path: '/code/generator',
            element: e(qe, { children: e(ia, {}) }),
          }),
          e(q, {
            exact: !0,
            path: '/code/validation',
            element: e(Kt, { children: e(na, {}) }),
          }),
          e(q, { path: '/signup', element: e(Jt, { children: e(la, {}) }) }),
          e(q, {
            path: '/reset-password',
            element: e(qe, { children: e(ra, {}) }),
          }),
          e(q, { path: '/multiStep', element: e(Ze, { children: e(ca, {}) }) }),
          e(q, {
            path: '/multiStep/end',
            element: e(Ze, { children: e(oa, {}) }),
          }),
          e(q, {
            exact: !0,
            path: '/',
            element: e(ee, { children: e($t, {}) }),
          }),
          e(q, {
            exact: !0,
            path: '/products/create',
            element: e(ee, { children: e(ba, {}) }),
          }),
          e(q, {
            exact: !0,
            path: '/products/list',
            element: e(ee, { children: e(wa, {}) }),
          }),
          e(q, {
            exact: !0,
            path: '/plant/create',
            element: e(ee, { children: e(Sa, {}) }),
          }),
          e(q, {
            exact: !0,
            path: '/plant/list',
            element: e(ee, { children: e(Ma, {}) }),
          }),
          e(q, {
            exact: !0,
            path: '/plant/update/:id',
            element: e(ee, { children: e(za, {}) }),
          }),
          e(q, {
            exact: !0,
            path: '/company/profile',
            element: e(ee, { children: e(Ia, {}) }),
          }),
          e(q, { path: '/component/form', element: e(ja, {}) }),
          e(q, { path: '/component/dropdown', element: e(Xa, {}) }),
          e(q, { path: '/component/alert', element: e(Ya, {}) }),
          e(q, { path: '/component/modal', element: e(as, {}) }),
          e(q, { path: '/component/tabs', element: e(ss, {}) }),
          e(q, { path: '/component/badge', element: e(ls, {}) }),
          e(q, { path: '/component/tooltip', element: e(rs, {}) }),
          e(q, { path: '*', element: e(ta, {}) }),
        ],
      }),
    })
  );
...
_t.render(
  e($.StrictMode, { children: e(Ut, { children: e(is, {}) }) }),
