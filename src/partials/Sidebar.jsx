                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                        href='#0'
                        className={`block text-white hover:text-gray-400 truncate transition duration-150 ${
                          pathname.includes('product') && 'hover:text-slate-200'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          sidebarExpanded
                        ...
                        <ul className={`pl-9 mt-1 ${!open && 'hidden'}`}>
                          <li className='mb-1 last:mb-0'>
                            <NavLink
                              ...
                              to='/products/create'
                              className={({ isActive }) =>
                                'block text-white hover:text-gray-400 transition duration-150 truncate ' +
                                (isActive ? '!text-primary' : '')
                              }>
                              <span className='text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200'>
                                Crear Productos
                  ...
                  return (
                    <React.Fragment>
                      <a
                        href='#0'
                        className={`block text-white hover:text-gray-400 truncate transition duration-150 ${
                          pathname.includes('company') && 'hover:text-slate-200'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          sidebarExpanded
